    ...
    <main className='container mx-auto md:px-[60px]'>
        <section className="lg:flex lg:h-[180vh]">
            ...
            <section className='lg:grow py-8 lg:py-32 lg:relative'> 
                <motion.article initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className='lg:w-[510px] lg:absolute lg:top-[10%] lg:left-[-30%]'>
                ...
                <motion.article initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className='lg:w-[406px] lg:mx-4 mt-12 lg:mt-[290px]'>
        ...
        <section className='h-[40vh] flex items-center justify-center'>
            <motion.article initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }}>
        ...
        <section className='relative flex flex-col gap-[80px] h-[400vh] lg:h-[280vh]'>
            <section className='lg:flex lg:gap-4'>
                <motion.div initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className='lg:grow'>
                    <img src={Slice} alt="slice"/>
                </motion.div>
                <motion.article initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className='lg:grow lg:w-[568px] flex flex-col justify-center'>
