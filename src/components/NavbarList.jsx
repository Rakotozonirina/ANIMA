...
const NavbarList = () => {
    return(
        <header className='xl:h-[300vh] relative px-[60px]'>
            ...
            <section className='h-[290vh] bg-stone-200/50'>
                ...
                <article className='gap-4 relative flex flex-col items-center justify-center h-[60vh]'>
                    ...
                    <h2 className='text-center text-gray-900 text-[32px] lg:text-[54px] font-bold leading-[65px]'>Liste des produits</h2>
